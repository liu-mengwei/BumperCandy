...
d.isCrossOrigin&&"file://"!==location.origin&&(n.crossOrigin="Anonymous");var p=function(){this.removeEventListener("load",p,!1);this.removeEventListener("error",r,!1);f.test(a)||(cc.loader.cache[a]=n);var b=e[a];if(b){for(var c=b.callbacks,d=0;d<c.length;++d){var h=c[d];h&&h(null,n)}b.img=null;delete e[a]}},s=this,r=function(){this.removeEventListener("error",r,!1);if(n.crossOrigin&&"anonymous"===n.crossOrigin.toLowerCase())d.isCrossOrigin=!1,s.release(a),cc.loader.loadImg(a,d,c);else{var b=e[a];
if(b){for(var f=b.callbacks,h=0;h<f.length;++h){var p=f[h];p&&p("load image failed")}b.img=null;delete e[a]}}};e[a]={img:n,callbacks:c?[c]:[]};n.addEventListener("load",p);n.addEventListener("error",r);n.src=a;return n},_loadResIterator:function(a,c,d){var e=this,n=null,p=a.type;p?(p="."+p.toLowerCase(),n=a.src?a.src:a.name+p):(n=a,p=cc.path.extname(n));if(c=e.getRes(n))return d(null,c);c=null;p&&(c=b[p.toLowerCase()]);if(!c)return cc.error("loader for ["+p+"] not exists!"),d();p=n;f.test(n)||(p=
...
a.LANGUAGE_ENGLISH;a.language=k;var m=k=!1,w="",A=0,y=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);y&&(k=!0,w=y[1]||"",A=parseInt(w)||0);if(y=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))m=!0,w=y[2]||"",A=parseInt(w)||0;y=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?y=a.OS_WINDOWS:m?y=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?y=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?y=a.OS_UNIX:k?y=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&
(y=a.OS_LINUX);a.os=y;a.osVersion=w;a.osMainVersion=A;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:
...
a.getImageData(0,0,1,1).data[0]}();cc.sys.isMobile&&(k=document.createElement("style"),k.type="text/css",document.body.appendChild(k),k.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var x=a.localStorage=b.localStorage;x.setItem("storage","");x.removeItem("storage");x=null}catch(C){x=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},
a.localStorage={getItem:x,setItem:x,removeItem:x,clear:x}}x=!!f.getContext("2d");k=!1;if(b.WebGLRenderingContext){m=document.createElement("CANVAS");try{if(cc.create3DContext(m,{stencil:!0})&&(k=!0),k&&a.os===a.OS_ANDROID){var B=parseFloat(a.browserVersion);switch(a.browserType){case a.BROWSER_TYPE_MOBILE_QQ:case a.BROWSER_TYPE_BAIDU:case a.BROWSER_TYPE_BAIDU_APP:k=6.2<=B?!0:!1;break;case a.BROWSER_TYPE_CHROME:k=30<=B?!0:!1;break;case a.BROWSER_TYPE_ANDROID:a.osMainVersion&&5<=a.osMainVersion&&(k=
!0);break;case a.BROWSER_TYPE_UNKNOWN:case a.BROWSER_TYPE_360:case a.BROWSER_TYPE_MIUI:case a.BROWSER_TYPE_UC:k=!1}}}catch(D){}m=null}B=a.capabilities={canvas:x,opengl:k};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)B.touches=!0;void 0!==e.onmouseup&&(B.mouse=!0);void 0!==e.onkeyup&&(B.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)B.accelerometer=!0;a.garbageCollect=function(){};a.dumpRoot=function(){};a.restartVM=function(){};a.cleanScript=function(a){};
...
a=cc._renderContext;null===b&&(c=a.createBuffer(),b=a.createBuffer());a=cc._renderContext;if(b){a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,b);for(var e=new Uint16Array(12E3),p=0,s=0;12E3>s;s+=6)e[s]=p+0,e[s+1]=p+1,e[s+2]=p+2,e[s+3]=p+1,e[s+4]=p+2,e[s+5]=p+3,p+=4;a.bufferData(a.ELEMENT_ARRAY_BUFFER,e,a.STATIC_DRAW)}c&&(g=48E3,f=new ArrayBuffer(4*g),h=new Float32Array(f),k=new Uint32Array(f),a.bindBuffer(a.ARRAY_BUFFER,c),a.bufferData(a.ARRAY_BUFFER,h,a.DYNAMIC_DRAW));d=8E3},getVertexSize:function(){return d},
...
b.disable(b.DEPTH_TEST)},pushRenderCommand:function(a){if(a.needDraw())if(this._isCacheToBufferOn){var b=this._cacheToBufferCmds[this._currentID];-1===b.indexOf(a)&&b.push(a)}else-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)},_increaseBatchingSize:function(a){e+=a},_uploadBufferData:function(b){e>=d&&this._batchRendering();var c=b._node._texture,f=b._node._blendFunc.src,g=b._node._blendFunc.dst,r=b._shaderProgram;if(a.texture!==c||a.blendSrc!==f||a.blendDst!==g||a.shader!==r)this._batchRendering(),
a.texture=c,a.blendSrc=f,a.blendDst=g,a.shader=r;b=b.uploadData(h,k,6*e);0<b&&(e+=b)},_batchRendering:function(){if(0!==e&&a.texture){var f=cc._renderContext,g=a.texture,k=a.shader,s=e/4;k&&(k.use(),k._updateProjectionUniform());cc.glBlendFunc(a.blendSrc,a.blendDst);cc.glBindTexture2DN(0,g);g=!f.bindBuffer(f.ARRAY_BUFFER,c);e>0.5*d?f.bufferData(f.ARRAY_BUFFER,h,f.DYNAMIC_DRAW):(k=h.subarray(0,6*e),f.bufferData(f.ARRAY_BUFFER,k,f.DYNAMIC_DRAW));g&&(f.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION),
f.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR),f.enableVertexAttribArray(cc.VERTEX_ATTRIB_TEX_COORDS),f.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,f.FLOAT,!1,24,0),f.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,f.UNSIGNED_BYTE,!0,24,12),f.vertexAttribPointer(cc.VERTEX_ATTRIB_TEX_COORDS,2,f.FLOAT,!1,24,16));f.bindBuffer(f.ELEMENT_ARRAY_BUFFER,b);f.drawElements(f.TRIANGLES,6*s,f.UNSIGNED_SHORT,0);cc.g_NumberOfDraws++;e=0}},rendering:function(b,c){var d=c||this._renderCmds,f,g,h,k=b||cc._renderContext;
...
regionProto.updateRegion=function(a,b){if(0==a.width||0==a.height)this.setEmpty();else{var c=b.a,d=b.b,e=b.c,f=b.d,g=b.tx,h=b.ty,k=a.x,m=a.y,n=k+a.width,p=m+a.height,s,r,u;if(1==c&&0==d&&0==e&&1==f)s=k+g-1,r=m+h-1,u=n+g+1,m=p+h+1;else{s=c*k+e*m+g;r=d*k+f*m+h;u=c*n+e*m+g;var m=d*n+f*m+h,t=c*n+e*p+g,n=d*n+f*p+h,g=c*k+e*p+g,h=d*k+f*p+h,p=0;s>u&&(p=s,s=u,u=p);t>g&&(p=t,t=g,g=p);s=(s<t?s:t)-1;u=(u>g?u:g)+1;r>m&&(p=r,r=m,m=p);n>h&&(p=n,n=h,h=p);r=(r<n?r:n)-1;m=(m>h?m:h)+1}this._minX=s;this._minY=r;this._maxX=
u;this._maxY=m;this._width=u-s;this._height=m-r;this._area=this._width*this._height}};function unionArea(a,b){return((a._maxX>b._maxX?a._maxX:b._maxX)-(a._minX<b._minX?a._minX:b._minX))*((a._maxY>b._maxY?a._maxY:b._maxY)-(a._minY<b._minY?a._minY:b._minY))}var DirtyRegion=function(){this.dirtyList=[];this.hasClipRect=!1;this.clipArea=this.clipHeight=this.clipWidth=0;this.clipRectChanged=!1},dirtyRegionProto=DirtyRegion.prototype;
...
!1}var h=c._rotationX||c._rotationY,k=c._skewX||c._skewY,m=c._scaleX,n=c._scaleY,g=this._anchorPointInPoints.x,p=this._anchorPointInPoints.y,s=1,r=0,u=0,t=1;if(h||k){e.tx=c._position.x;e.ty=c._position.y;h&&(s=0.017453292519943295*c._rotationX,u=Math.sin(s),t=Math.cos(s),c._rotationY===c._rotationX?(s=t,r=-u):(r=0.017453292519943295*c._rotationY,s=Math.cos(r),r=-Math.sin(r)));e.a=s*=m;e.b=r*=m;e.c=u*=n;e.d=t*=n;k&&(k=Math.tan(c._skewX*Math.PI/180),m=Math.tan(c._skewY*Math.PI/180),Infinity===k&&(k=
99999999),Infinity===m&&(m=99999999),e.a=s+u*m,e.b=r+t*m,e.c=u+s*k,e.d=t+r*k);if(g||p)e.tx-=e.a*g+e.c*p,e.ty-=e.b*g+e.d*p,c._ignoreAnchorPointForPosition&&(e.tx+=g,e.ty+=p);d?(f.a=e.a*d.a+e.b*d.c,f.b=e.a*d.b+e.b*d.d,f.c=e.c*d.a+e.d*d.c,f.d=e.c*d.b+e.d*d.d,f.tx=d.a*e.tx+d.c*e.ty+d.tx,f.ty=d.d*e.ty+d.ty+d.b*e.tx):(f.a=e.a,f.b=e.b,f.c=e.c,f.d=e.d,f.tx=e.tx,f.ty=e.ty)}else{e.a=m;e.b=0;e.c=0;e.d=n;e.tx=c._position.x;e.ty=c._position.y;if(g||p)e.tx-=e.a*g,e.ty-=e.d*p,c._ignoreAnchorPointForPosition&&(e.tx+=
...
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=u;a[8]=c;a[9]=k;a[11]=t;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],u=k[6],t=k[7],v=k[8],z=k[9],w=k[10],A=k[11],y=k[12],x=k[13],C=k[14],k=k[15],B=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=B*c+D*s+E*v+F*y;d[1]=B*b+D*r+E*z+F*x;d[2]=B*n+D*u+E*w+F*C;d[3]=B*p+D*t+E*A+F*k;d[4]=G*c+H*s+I*v+J*y;d[5]=
G*b+H*r+I*z+J*x;d[6]=G*n+H*u+I*w+J*C;d[7]=G*p+H*t+I*A+J*k;d[8]=K*c+L*s+M*v+N*y;d[9]=K*b+L*r+M*z+N*x;d[10]=K*n+L*u+M*w+N*C;d[11]=K*p+L*t+M*A+N*k;d[12]=O*c+P*s+Q*v+m*y;d[13]=O*b+P*r+Q*z+m*x;d[14]=O*n+P*u+Q*w+m*C;d[15]=O*p+P*t+Q*A+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],u=b[8],t=b[9],v=b[10],z=b[11],w=b[12],A=b[13],y=b[14],x=b[15],C=c[0],B=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=C*a+B*n+D*u+E*w;b[1]=C*d+B*p+D*t+E*A;b[2]=C*k+B*s+D*v+E*y;b[3]=C*m+B*r+D*z+E*x;b[4]=F*a+G*n+H*u+I*w;b[5]=F*d+G*p+H*t+I*A;b[6]=F*k+G*s+H*v+I*y;b[7]=F*m+G*r+H*z+I*x;b[8]=J*a+K*n+L*u+M*w;b[9]=J*d+K*p+L*t+M*A;b[10]=J*k+K*s+L*v+M*y;b[11]=J*m+K*r+L*z+M*x;b[12]=N*a+O*n+P*u+c*w;b[13]=N*d+O*p+P*t+c*A;b[14]=N*k+O*s+P*v+c*y;b[15]=N*m+O*r+P*z+c*x;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
cc._drawingUtil.drawPoly(a,4,!0)}};a.updateAtlasValues=function(){var a=this._node,c=a._string,d=c.length,e=this._textureAtlas,f=e.texture,g=f.pixelsWidth,f=f.pixelsHeight,h=a._itemWidth,k=a._itemHeight;a._ignoreContentScaleFactor||(h=a._itemWidth*cc.contentScaleFactor(),k=a._itemHeight*cc.contentScaleFactor());d>e.getCapacity()&&cc.log("cc.LabelAtlas._updateAtlasValues(): Invalid String length");for(var m=e.quads,n=a._itemWidth,p=a._itemHeight,s=0,r=-1;s<d;s++){var u=c.charCodeAt(s)-a._mapStartChar.charCodeAt(0),
t=u%a._itemsPerRow,v=0|u/a._itemsPerRow;if(!(0>t||0>v||t*n+n>g||v*p+p>f)){r++;var z;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(t=(2*t*h+1)/(2*g),u=t+(2*h-2)/(2*g),v=(2*v*k+1)/(2*f),z=v+(2*k-2)/(2*f)):(t=t*h/g,u=t+h/g,v=v*k/f,z=v+k/f);var w=m[s],A=w.tl,y=w.tr,x=w.bl,w=w.br;A.texCoords.u=t;A.texCoords.v=v;y.texCoords.u=u;y.texCoords.v=v;x.texCoords.u=t;x.texCoords.v=z;w.texCoords.u=u;w.texCoords.v=z;x.vertices.x=r*n;x.vertices.y=0;x.vertices.z=0;w.vertices.x=r*n+n;w.vertices.y=0;w.vertices.z=0;A.vertices.x=
r*n;A.vertices.y=a._itemHeight;A.vertices.z=0;y.vertices.x=r*n+n;y.vertices.y=a._itemHeight;y.vertices.z=0}}this._updateColor();this.updateContentSize(s,r+1);0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.updateContentSize=function(a,c){var d=this._node,e=d._contentSize;a!==c&&a*d._itemWidth===e.width&&d._itemHeight===e.height&&d.setContentSize(c*d._itemWidth,d._itemHeight)};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};
...
void 0===c?-1:c,this._realOpacity=255,this._realColor=cc.color(255,255,255,255),this._contentSize.width=0,this._contentSize.height=0,this.setAnchorPoint(0.5,0.5),this.setString(a,!0),!0):!1},createFontChars:function(){var a=this._renderCmd,b=a._texture||this._texture,c=0,d=cc.size(0,0),e=0,f=1,g=this._string,h=g?g.length:0;if(0!==h){var k,m=this._config,n=m.kerningDict,p=m.commonHeight,s=m.fontDefDictionary;for(k=0;k<h-1;k++)10===g.charCodeAt(k)&&f++;var r=p*f,f=-(p-p*f),u=-1,t;for(k=0;k<h;k++)if(p=
g.charCodeAt(k),0!==p)if(10===p)c=0,f-=m.commonHeight;else{u=n[u<<16|p&65535]||0;t=s[p];t||(cc.log("cocos2d: LabelBMFont: character not found "+g[k]),t={rect:{x:0,y:0,width:0,height:0},xOffset:0,yOffset:0,xAdvance:0});var v=cc.rect(t.rect.x,t.rect.y,t.rect.width,t.rect.height),v=cc.rectPixelsToPoints(v);v.x+=this._imageOffset.x;v.y+=this._imageOffset.y;var z=this.getChildByTag(k);z?a._updateCharTexture(z,v,p):(z=new cc.Sprite,z.initWithTexture(b,v,!1),z._newTextureWhenChangeColor=!0,this.addChild(z,
0,k));z.opacityModifyRGB=this._opacityModifyRGB;a._updateCharColorAndOpacity(z);v=cc.p(c+t.xOffset+0.5*t.rect.width+u,f+(m.commonHeight-t.yOffset)-0.5*v.height*cc.contentScaleFactor());z.setPosition(cc.pointPixelsToPoints(v));c+=t.xAdvance+u;u=p;e<c&&(e=c)}d.width=t&&t.xAdvance<t.rect.width?e-t.xAdvance+t.rect.width:e;d.height=r;this.setContentSize(cc.sizePixelsToPoints(d))}},updateString:function(a){var b=this._children;if(b)for(var c=0,d=b.length;c<d;c++){var e=b[c];e&&(e.visible=!1)}this._config&&
...
this._mask_layer_le,this._mask_layer_le);a.stencilOp(a.KEEP,a.KEEP,a.KEEP)};a._onAfterVisit=function(a){a=a||cc._renderContext;cc.ClippingNode.WebGLRenderCmd._layer--;if(this._currentStencilEnabled){var c=1<<cc.ClippingNode.WebGLRenderCmd._layer,d=c|c-1;a.stencilMask(c);a.stencilFunc(a.EQUAL,d,d)}else a.disable(a.STENCIL_TEST)}})();var g_resources="res/0.png res/1.png res/2.png res/3.png res/4.png res/bg.jpg".split(" ");var BumperCandyMainScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}});var Constant={CANDY_TYPE_COUNT:5,SUCCESSTIP_WIDTH:500,SUCCESSTIP_HEIGHT:500,CANDY_HOR_SIZE:10,CANDY_VER_SIZE:10,CANDY_SIZE:64,FALL_ACCELERATION:400,CHECK_POINTS:[{limitStep:15,targetScore:450},{limitStep:10,targetScore:850},{limitStep:5,targetScore:1E3}]};var GameLayer=cc.Layer.extend({score:null,step:null,surplusStep:null,level:null,targetScore:null,ui:null,candyMap:null,bg:null,map:null,allowFalls:!0,gameover:!1,ctor:function(){this._super();this.score=Storage.getCurrentScore();this.level=Storage.getCurrentLevel();this.step=0;this.surplusStep=Constant.CHECK_POINTS[this.level-1].limitStep-this.step;this.targetScore=Constant.CHECK_POINTS[0].targetScore;this.initBackGround();this.initCandyClipping();this.initCandyMap();this.ui=new GameUI(this);this.addChild(this.ui,
3);this.addCandyListener()},initCandyClipping:function(){var a=new cc.ClippingNode,b=new cc.Layer;b.x=(this.bg.width-Constant.CANDY_HOR_SIZE*Constant.CANDY_SIZE)/2;b.y=(this.bg.height-Constant.CANDY_VER_SIZE*Constant.CANDY_SIZE)/2;this.addChild(a,2);this.candyMap=b;a.addChild(this.candyMap,1);var c=new cc.DrawNode;c.drawRect(cc.p(b.x,b.y),cc.p(b.x+Constant.CANDY_HOR_SIZE*Constant.CANDY_SIZE,b.y+Constant.CANDY_VER_SIZE*Constant.CANDY_SIZE),cc.color(0,0,0),1,cc.color(0,0,0));a.stencil=c},initCandyMap:function(){this.map=
[];for(var a=0;a<Constant.CANDY_HOR_SIZE;a++){for(var b=[],c=0;c<Constant.CANDY_VER_SIZE;c++){var d=Candy.createRamdomType(a,c);this.candyMap.addChild(d);d.x=Constant.CANDY_SIZE*c+Constant.CANDY_SIZE/2;d.y=Constant.CANDY_SIZE*a+Constant.CANDY_SIZE/2;b.push(d)}this.map.push(b)}},initBackGround:function(){var a=new cc.Sprite("res/bg.jpg"),b=cc.director.getWinSize();a.x=b.width/2;a.y=b.height/2;this.addChild(a,1);this.bg=a},addCandyListener:function(){"touches"in cc.sys.capabilities?cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,
onTouchBegan:this._onTouchBegan.bind(this)},this.candyMap):cc.eventManager.addListener({event:cc.EventListener.MOUSE,onMouseDown:this._onMouseDown.bind(this)},this.candyMap)},_onTouchBegan:function(a,b){if(!1!=this.allowFalls){this.allowFalls=!1;var c=(cc.director.getWinSize().height-Constant.CANDY_SIZE*Constant.CANDY_VER_SIZE)/2,d=(cc.director.getWinSize().width-Constant.CANDY_SIZE*Constant.CANDY_VER_SIZE)/2,d=Math.floor((a.getLocation().x-d)/Constant.CANDY_SIZE),c=Math.floor((a.getLocation().y-
c)/Constant.CANDY_SIZE),e=this.initArray();this.searchConCandy(e,c,d);this.score+=this.removeCandy(e);this.step++;this.surplusStep=Constant.CHECK_POINTS[this.level-1].limitStep-this.step;this.checkSuccessOrFail()}},checkSuccessOrFail:function(){this.score>=Constant.CHECK_POINTS[this.level-1].targetScore&&this.level<Constant.CHECK_POINTS.length?(this.ui.showSuccess(),this.gameover=!0,this.scheduleOnce(function(){cc.director.runScene(new BumperCandyMainScene)},3),this.level++):this.score>=Constant.CHECK_POINTS[this.level-
1].targetScore&&this.level==Constant.CHECK_POINTS.length?(this.ui.showRestart(),this.gameover=!0,this.score=0,this.level=1,this.scheduleOnce(function(){cc.director.runScene(new BumperCandyMainScene)},3)):this.score<Constant.CHECK_POINTS[this.level-1].targetScore&&this.step==Constant.CHECK_POINTS[this.level-1].limitStep&&(this.ui.showFail(),this.gameover=!0,this.score=0,this.level=1,this.scheduleOnce(function(){cc.director.runScene(new BumperCandyMainScene)},3));Storage.setCurrentLevel(this.level);
Storage.setCurrentScore(this.score)},_onMouseDown:function(a,b){this._onTouchBegan(a,b)},initArray:function(){for(var a=[],b=0;b<Constant.CANDY_VER_SIZE;b++){for(var c=[],d=0;d<Constant.CANDY_HOR_SIZE;d++)c[d]=0;a.push(c)}return a},searchConCandy:function(a,b,c){var d=this.map[b][c];a[b][c]=1;b+1<=Constant.CANDY_VER_SIZE-1&&0==a[b+1][c]&&this.map[b+1][c].type==d.type&&this.searchConCandy(a,b+1,c);0<=b-1&&0==a[b-1][c]&&this.map[b-1][c].type==d.type&&this.searchConCandy(a,b-1,c);0<=c-1&&0==a[b][c-1]&&
this.map[b][c-1].type==d.type&&this.searchConCandy(a,b,c-1);c+1<=Constant.CANDY_HOR_SIZE-1&&0==a[b][c+1]&&this.map[b][c+1].type==d.type&&this.searchConCandy(a,b,c+1)},removeCandy:function(a){for(var b=0,c=0,d=0;d<Constant.CANDY_HOR_SIZE;d++){for(var e=[],f=[],g=0,h=0;h<Constant.CANDY_VER_SIZE;h++){if(1==a[h][d]){this.candyMap.removeChild(this.map[h][d]);var k=Candy.createRamdomType(h,d);e.push(k);this.candyMap.addChild(k);k.x=Constant.CANDY_SIZE*d+Constant.CANDY_SIZE/2;k.y=Constant.CANDY_VER_SIZE*
Constant.CANDY_SIZE+Constant.CANDY_SIZE/2+Constant.CANDY_SIZE*(e.length-1);g++}0==a[h][d]&&(this.map[h][d].count=g,f.push(this.map[h][d]))}for(h=0;h<e.length;h++)e[h].count=g,f.push(e[h]);c+=e.length;for(g=0;g<Constant.CANDY_VER_SIZE;g++)this.map[g][d]=f[g];0!=e.length&&(g=0,g=this.candyFall(f,e.length),b<g&&(b=g))}this.scheduleOnce(this.finishCandyFalls.bind(this),b);return 10*c},finishCandyFalls:function(){!1==this.gameover&&(this.allowFalls=!0)},candyFall:function(a){for(var b=0;b<a.length;b++){var c=
a[b].count*Constant.CANDY_SIZE,d=Math.sqrt(2*c/Constant.FALL_ACCELERATION),c=cc.moveTo(d,cc.p(a[b].x,a[b].y-c)).easing(cc.easeIn(2));a[b].runAction(c)}return d}});var GameUI=cc.Layer.extend({levelText:null,scoreText:null,stepText:null,gameLayer:null,ctor:function(a){this._super();this.initInfoPanel();this.gameLayer=a;this.scheduleUpdate()},initInfoPanel:function(){var a=cc.director.getWinSize(),b=new cc.LabelTTF("\u7b49\u7ea7:","arial",36);b.x=100;b.y=a.height-50;this.addChild(b);a=new cc.LabelTTF("1","arial",36);a.x=b.x+60;a.y=b.y;this.addChild(a);this.levelText=a;var c=new cc.LabelTTF("\u5f97\u5206:","arial",36);c.x=300;c.y=b.y;this.addChild(c);var d=new cc.LabelTTF("0",
"arial",36);d.x=c.x+80;d.y=b.y;this.addChild(d);this.scoreText=d;var e=new cc.LabelTTF("\u5269\u4f59\u6b65\u6570:","arial",36);e.x=550;e.y=b.y;this.addChild(e);var f=new cc.LabelTTF("0","arial",36);f.x=e.x+100;f.y=b.y;this.addChild(f);this.stepText=f;b.setColor(cc.color(0,0,0));a.setColor(cc.color(0,0,0));c.setColor(cc.color(0,0,0));d.setColor(cc.color(0,0,0));e.setColor(cc.color(0,0,0));f.setColor(cc.color(0,0,0))},update:function(){this.levelText.setString(this.gameLayer.level);this.scoreText.setString(this.gameLayer.score);
this.stepText.setString(this.gameLayer.surplusStep)},showInfo:function(a){var b=cc.director.getWinSize();a=new cc.LabelTTF(a,"ariel",50);a.x=b.width/2;a.y=b.height/2;a.setColor(cc.color(0,0,0));this.addChild(a)},showSuccess:function(){this.showInfo("\u606d\u559c\u4f60\u8fdb\u5165\u4e0b\u4e00\u5173 \u5f97\u5206"+this.gameLayer.score)},showFail:function(){this.showInfo("\u4f60\u592a\u6c34\u4e86 \u8fd4\u56de\u7b2c\u4e00\u5173")},showRestart:function(){this.showInfo("\u592a\u725b\u903c\u4e86")}});var Candy=cc.Sprite.extend({type:0,column:0,row:0,count:0,ctor:function(a,b,c){this._super("res/"+a+".png");this.init(a,b,c)},init:function(a,b,c){this.type=a;this.column=b;this.row=c}});Candy.createRamdomType=function(a,b){return new Candy(parseInt(Math.random()*Constant.CANDY_TYPE_COUNT),a,b)};var Storage={setCurrentLevel:function(a){cc.sys.localStorage.setItem("level",a);return!0},setCurrentScore:function(a){cc.sys.localStorage.setItem("score",a);return!0},getCurrentLevel:function(){var a=cc.sys.localStorage.getItem("level")||1;return parseInt(a)},getCurrentScore:function(){var a=cc.sys.localStorage.getItem("score")||0;return parseInt(a)}};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new BumperCandyMainScene)},this)};cc.game.run();